// Rewriting TTT with OLOO pattern - create an object as prototype, then use Object.create to making new objects.
...
let Board = {
  ...
  display() {
    ...
    console.log("-----+-----+-----");
    console.log("     |     |");
    console.log(`  ${this.squares[5]}  |  ${this.squares[8]}  |  ${this.squares[9]}  `);
    console.log("     |     |");
    console.log("");
  },
