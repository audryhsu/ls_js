// he function from the previous exercise returns the number of occurrences of a word in some text. Although this is useful, there are also situations in which we just want to find the word in the context of the text.
//
...
//find the index position where word occurs, and replace it with transformed word.
...
function searchWord(word, text) {
  ...
  let result = text.replace(re, `**${word.toUpperCase()}**`)
  console.log(result);
}
